...
# ── Tell Playwright where to find the browser binary ──────────
# Must match the PLAYWRIGHT_BROWSERS_PATH env var set in Render
os.environ.setdefault(
    "PLAYWRIGHT_BROWSERS_PATH",
    "/opt/render/project/src/.playwright"
)

# ── Shared launch args for Render's constrained environment ───
LAUNCH_ARGS = [
    "--no-sandbox",
