...
// Domains allowed through the /api/rss/article extractor.
 ...
 * request is blocked (403, 5xx from a WAF, or timeout).
 */
...
/**
 * Validate that an article URL belongs to an allowed domain.
 * Must be defined before the /rss/article route that calls it.
 */
